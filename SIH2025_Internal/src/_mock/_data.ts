...
export const _notifications = [
  {
    ...
    description: 'A theft complaint from Mumbai has been assigned to you.',
    avatarUrl: null,
    type: 'order-placed',
    postedAt: _times(1),
    isUnRead: true,
  ...
  {
    id: _id(2),
    title: 'IPC Section matched',
    description: 'IPC 379 has been automatically matched to complaint #1234.',
  ...
  },
  {
    ...
    description: 'Complaint #1230 has been marked as resolved.',
    avatarUrl: null,
    type: 'chat-message',
    postedAt: _times(3),
    isUnRead: false,
  },
  {
    id: _id(4),
    title: 'System Update',
    description: 'YURUS IPC Mapper will be updated tonight at 2 AM.',
    avatarUrl: null,
    type: 'mail',
    postedAt: _times(4),
    isUnRead: false,
  },
  {
    ...
    description: 'Your analytics report for this month is ready to view.',
    avatarUrl: null,
    type: 'order-shipped',
    postedAt: _times(5),
    isUnRead: false,
